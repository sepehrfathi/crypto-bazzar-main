...
import 'package:Arzex/components/for_you_section.dart';
import 'package:Arzex/components/wallets.dart';
import 'package:Arzex/data/constant/constants.dart';
import 'package:Arzex/data/model/crypto.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ' Arzex.top | ارزکس',
          style: TextStyle(fontFamily: 'mr', color: Colors.black87),
        ),
        centerTitle: true,
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(
                left: pageHorizontalPadding, right: pageHorizontalPadding),
